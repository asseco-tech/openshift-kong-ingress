...
# image configuration
image_name="${kong_image_name}"
image_tag="${kong_image_tag}"
custom_image_name="${custom_kong_image_name}"
image_baseurl="${kong_image_baseurl}"
...
[ -d plugins ] && . copy-plugins.sh ${tmp_folder}
